...
import 'neon_digital_clock.dart';
...
void main() {
  ...
  // own clock widget. (Look in neon_digital_clock.dart for more details!)
  runApp(ClockCustomizer((ClockModel model) => NeonDigitalClock(model)));
}
